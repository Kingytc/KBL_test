...
String strusrFunction = Helper.correctNull((String) hshValues.get("strusrFunction"));
String strpan = Helper.correctNull((String) hshValues.get("strpan"));
...
var strusrFunction="<%=strusrFunction%>";
var strpan="<%=strpan%>";
...
{
	if(strpan=="" || strpan=="NOPAN")
	{
		alert("Please capture PAN No. in Finacle CRM - visit LAPS customer Profile - then click  '' Update CBS Customer ID ''");
		return;
	}
...
<%} %>
  <table width="100%" border="0" cellspacing="1" cellpadding="3"  align="center" class="outertable">
    	...
    	<tr>
                <%
                	String StrPADate = "", StrPANDate = "", StrPAUser = "", StrPANUser = "", StrADDDate = "", StrADDUser = "",
                			StrEMPDate = "", StrEMPUser = "", StrBNKDate = "", StrBNKUser = "", StrMENDate = "",
                			StrMENUser = "", strucicdedupeflag = "", strperapppannum = "", strperappaadhar = "";
                	...
                	if (arrRow.size() > 0 && arrRow != null) {
                		for (int i = 0; i < arrRow.size(); i++) {
                			...
                			strucicdedupeflag = Helper.correctNull((String) arrCol.get(44));//shiva
                			strperapppannum = Helper.correctNull((String) arrCol.get(45));//shiva
                			strperappaadhar = Helper.correctNull((String) arrCol.get(46));//shiva
