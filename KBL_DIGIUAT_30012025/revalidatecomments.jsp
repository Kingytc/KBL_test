...
function onLoading()
{
	...
	else if(varStatus=="sendback")
	{
		...
		else if(strstatus=="ps")
		{
			if(strUser_revalidate==struserID)
			{
				disableCommandButtons(false,false,true,true,false,true,true,true);
			}
			else
			{
				disableCommandButtons(true,true,true,true,false,true,true,true);
...
{	
	...
	{
		 	alert( 'Kindly View the Revalidation document under Documents- Post Sanction Document Attachment-SANCTION REVALIDATION CUSTOMER REQUEST AND BRANCH RECOMMENDATION' );
	        return;
	}
	...
	if(userorglevel!="A")
	{
		var messageLength1 = CKEDITOR.instances['txtarea_comments1'].getData().replace(/<[^>]*>/gi, '').length;
	    if( !messageLength1 ) {
	        alert( 'Enter Reason in the field Revalidation Approval Comments' );
	        return;
	    }
	}
...
<br>
<marquee height="70px" style="color:red; font-size:20px;">
			Kindly do not copy paste the content to any of the comment field below.
			</marquee>
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0"
			...
			<tr>
						...
						<div id="id_editor6"><textarea name="txt_reasonfordelay"
							cols="30" rows="8" onKeyPress="textlimit(this,199);checkSplDotC(this);" onKeyUp="textlimit(this,199);checkSplDotC(this);"><%=Helper.correctNull((String)hshValues.get("APP_DELAYFACILITY")) %></textarea></div>
						</td>
			</tr>
			...
			<tr>
						...
						<div id="id_editor5"><textarea name="txt_branchrecomend"
							cols="30" rows="4" onKeyPress="textlimit(this,199);checkSplDotC(this);" onKeyUp="textlimit(this,199);checkSplDotC(this);"><%=Helper.correctNull((String)hshValues.get("APP_BRNRECOMMEND")) %></textarea></div>
						</td>
			</tr>
			...
			<tr>
						...
						<div id="id_editor4"><textarea name="txt_deptrecomend"
							cols="30" rows="4" onKeyPress="textlimit(this,199);checkSplDotC(this);" onKeyUp="textlimit(this,199);checkSplDotC(this);"><%=Helper.correctNull((String)hshValues.get("APP_DEPTCOMMENTS")) %></textarea></div>
						</td>
			</tr>
				...
				<table width="100%" border="0" cellpadding="3" cellspacing="0"
					...
					<tr style="display:none">
						...
						<div id="id_editor"><textarea name="txtarea_comments"
							cols="30" rows="8" onKeyPress="textlimit(this,199);checkSplDotC(this);" onKeyUp="textlimit(this,3999)"><%=Helper.correctNull((String)hshValues.get("APP_REVALIDATION_REASON")) %></textarea></div>
						</td>
					</tr>
					...
					<tr>
						...
						<div id="id_editor1"><textarea name="txtarea_comments1"
							cols="30" rows="8" onKeyPress="textlimit(this,199);checkSplDotC(this);" onKeyUp="textlimit(this,199);checkSplDotC(this);"><%=Helper.correctNull((String)hshValues.get("APP_SANCTION_CMTS")) %></textarea></div>
						</td>
					</tr>
				</table>
				<!-- changes on 10092024 -->	
